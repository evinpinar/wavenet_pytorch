...
class HParams(object):
    ...
    def to_yaml(self):
        """Serialize the hyperparameters into YAML
    ...
    def parse_yaml(self, values_yaml):
        """Override hyperparameter values, parsing new values from a YAML object.
        Args:
          values_yaml: String containing a YAML object of name:value pairs.
        Returns:
          The `HParams` instance.
        Raises:
          ValueError: If `values_yaml` cannot be parsed.
        """
        values_map = yaml.load(values_yaml)
        return self.override_from_dict(values_map)
...
def write_params_to_yaml(hparams, yaml_path):
    """Write HParams to YAML file.
    ...
    with open(yaml_path, 'w') as yaml_file:
        yaml_file.write(hparams.to_yaml())
